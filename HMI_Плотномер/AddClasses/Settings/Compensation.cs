...
namespace IDensity.AddClasses.Settings
{
    class Compensation :PropertyChangedBase
    {
        ...
        /// Коэффициент А
        /// </summary>
        public Parameter<float> A => new Parameter<float>("CompensationA", "Коэффициент А", float.MinValue, float.MaxValue, 0, "");
        #endregion
        #region Коэффициент B
        /// <summary>
        /// Коэффициент B
        /// </summary>
        public Parameter<float> B => new Parameter<float>("CompensationB", "Коэффициент B", float.MinValue, float.MaxValue, 0, "");
        #endregion
        #region Коэффициент C
        /// <summary>
        /// Коэффициент C
        /// </summary>
        public Parameter<float> C => new Parameter<float>("CompensationC", "Коэффициент C", float.MinValue, float.MaxValue, 0, "");
        #endregion
