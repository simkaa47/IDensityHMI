...
namespace IDensity.Core.Models.Counters
{
    /// <summary>
    ...
    public class CountDiapasone : PropertyChangedBase, ICloneable
    {
        ...
        public object Clone()
        {
            ...
            {
                Num = Num.Clone() as Parameter<ushort>,
                Start = Start.Clone() as Parameter<ushort>,
                Width = Width.Clone() as Parameter<ushort>,
                CounterMode = CounterMode.Clone() as Parameter<ushort>,
                CountPeakFind = CountPeakFind.Clone() as Parameter<float>,
                CountPeakSmooth = CountPeakSmooth.Clone() as Parameter<float>,
                CountBotPerc = CountBotPerc.Clone() as Parameter<ushort>,
                CountTopPerc = CountTopPerc.Clone() as Parameter<ushort>
            };
        }
